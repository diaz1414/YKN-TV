...
const t = (key: string, lang: string = 'id'): string => {
  const translations: Record<string, Record<string, string>> = {
    id: {
      ...
      'error_loading': 'Oops! Skor live terbaru gagal dimuat. Coba refresh halaman beberapa saat lagi ya.',
    ...
    en: {
      ...
      'error_loading': 'Oops! Failed to load the latest live scores. Please try again in a moment.',
